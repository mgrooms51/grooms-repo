...
assert split_name("Snoop Dogg") =={
    "first_name": "Snoop",
    "last_name": "Dogg",
}, f"Expected {{'first_name': 'Snoop', 'last_name': 'Dogg'}} but recevived {split_name('Snoop Dogg')}"

# 2) Ensure that 'split_name' can handle multi-word last names

assert split_name("Snoop Doggy Dogg") == {
    "first_name": "Snoop",
    "last_name": "Doggy Dogg",
},  f"Expected {{'first_name': 'Snoop', 'last_name': 'Doggy Dogg'}} but recevived {split_name('Snoop Doggy Dogg')}"
